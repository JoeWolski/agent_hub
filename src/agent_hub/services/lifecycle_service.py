        ...
        if isinstance(projects, dict):
            for project_id in projects.keys():
                state_runtime._remove_orphan_children(
                    ...
                    ignore_delete_errors=True,
                    orphan_kind="project tmp child",
                )
        removed_orphan_log_entries = state_runtime._remove_orphan_log_entries(state, ignore_delete_errors=True)
